  ...
  return (
    <>
      <div className="signupPage h-screen p-10   flex flex-col items-center justify-center bg-honeydew overflow-hidden z-0 ">
        ...
        <div className=" white-box  px-1 max-h-screen py-2 w-5/6 md:w-4/5 md:py-6  lg:h-3/4 lg:w-3/4 bg-white rounded-xl z-20 shadow-xl lg:px-5 flex items-center justify-center">
          <div className="left-box hidden bg-honeydew w-1/2 h90 rounded-l-xl overflow-hidden relative lg:p-8 lg:flex flex-col items-center justify-center">
            ...
            <h1 className="text-3xl text-jet font-bold text-center z-20 mb-4">
              Welcome to <span className="text-5xl text-yellow-400">KabadiKorner!</span>
            </h1>
          ...
          <div className="right-box bg-white h90 w-full lg:w-1/2 ">
              ...
              <div className="max-w-md mx-auto ">
                <div className="text-center ">
                  ...
                  <p className="text-sm text-center text-gray-400">Already have an account? <Link to="/login" className="text-jungle_green font-semibold hover:underline focus:underline focus:text-red-400">Log In</Link>.</p>
                </div>
