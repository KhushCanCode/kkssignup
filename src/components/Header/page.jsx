...
const Header = () => {
  ...
  return (
    <nav className='sticky bg-white text-black flex flex-col'>
      ...
      <div className="links group flex gap-[2.4vw] justify-end border-t-[.3vh] border-black py-[1vw] px-[2vw] hover:h-[5vw] align-middle">
        {routes.map((route) => (
